    ...
    */
    public void testLocationTable() {
        ...
        // Insert ContentValues into database and get a row ID back
         long row = db.insert(WeatherContract.LocationEntry.TABLE_NAME,"",cv);
        ...
        // query if you like)
        TestUtilities.validateCursor("Error", locationCursor,cv);
    ...
    public void testWeatherTable() {
        ...
        // Insert ContentValues into database and get a row ID back
        long row = db.insert(WeatherContract.LocationEntry.TABLE_NAME,"",locationContent);
        assertTrue("Success: Successful row insertion ", row != -1);
        ...
        ContentValues weatherContent = TestUtilities.createWeatherValues(row);

        // Insert ContentValues into database and get a row ID back
        db.insert(WeatherContract.WeatherEntry.TABLE_NAME,"",weatherContent);
        ...
        // (you can use the validateCurrentRecord function in TestUtilities to validate the
        // query if you like)
        TestUtilities.validateCursor("Error",weatherCursor,weatherContent);
        // Finally, close the cursor and database
