...
public class ForecastFragment extends Fragment {
    ...
    public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
        ...
        protected String[] doInBackground(String... strings) {
            ...
            // if there is no zip code, there is nothing to lookup
            if(strings.length == 0){
                return null;
            }
            ...
            try {
                ...
                Uri buitlUri = Uri.parse(FORECAST_BASE_URL).buildUpon()
                ...
                URL url = new URL(buitlUri.toString());

                Log.v(LOG_TAG,"Built URI : " + buitlUri.toString());
                ...
                Log.e("ForecastFragment", "Error",je);
            }finally{
        ...
        private String[] getWeatherDataFromJson(String forecastJsonStr, int numDays)
            ...
            getString(R.string.prefUnitKey),
